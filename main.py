# Задание 1: Напишите функцию read_last(lines, file),
...
# который заполняется через 3 трубы, слишком проста.
...
# Номер трубы соответствует номеру строки,
# в которой записана ее производительность.
